	...
	<script>
		...
		function detail(e){
			...
			*/
			...
			$('#img-modal').attr('src', $(e).find('modal-img').attr('src'));
			$('.modal-title').html($(e).find('modal-title').text());
			$('#modal-writer').html($(e).find('thumbnaiumbnail-writer').text());
		...
		<section class="bg-light" id="portfolio" style="padding-top: 90px; padding-bottom: 0;">
			<div class="container">
				...
				<c:forEach items="${ board }" var="img">
					...
					<input type="hidden" class="thumbnail-contetent" value="${img.boardContent }"/>
						<a class="portfolio-link" data-toggle="modal" href="#MyModal">
							<div class="portfolio-hover">
								<div class="portfolio-hover-content">
								</div>
							</div>
							<img class="img-thumbnail img-fluid thumbnail-img" src="${img.changeName }" alt="게시글 이미지">
						</a>
						<div class="portfolio-caption">
							<h4 class="thumbnail-title">${boardTitle }</h4>
